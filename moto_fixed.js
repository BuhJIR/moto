...
(function(global) {
  ...
  function extendWorld(worldInstance) {
    ...
    // Get Box2D module reference - MUST contain b2Vec2, b2BodyDef, etc.
    ...
    worldInstance.add = function(obj) {
      ...
      // Create BodyDef - use b2.b2BodyDef, not global b2BodyDef
      ...
      if (obj.linearVelocity) {
        var lv = new b2.b2Vec2(obj.linearVelocity.x, obj.linearVelocity.y);
    ...
    worldInstance.addJoint = function(obj) {
      ...
      switch (type) {
        ...
        case 'prismatic':
          ...
          var axisDir = obj.angle || new b2.b2Vec2(0, 1);
  ...
  Rider.prototype = {
    ...
    eject: function() {
      ...
      if (!this.moto.isDead) {
        this.moto.kill();
        var force = new b2.b2Vec2(150.0 * this.mirror, 0);
  ...
  Moto.prototype = {
    ...
    createPrismaticJoint: function(axle, cst) {
      var b2 = getB2();
      var axisVec = new b2.b2Vec2(this.mirror * cst.angle.x, cst.angle.y);
      return this.world.addJoint({
        type: 'prismatic',
        bodyA: this.body,
        bodyB: axle,
